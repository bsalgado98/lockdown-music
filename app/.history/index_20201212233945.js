...
function genresChart(jsonData) {
    ...
    const grammysGenresData = Object.values(jsonData)
    const grammysGenresChart = new Chart(grammysGenresCtx, {
        type: 'line',
        data: {
            labels: ['r&b', 'rap', 'jazz', 'rock', 'folk', 'indie', 'pop', 'country', 'soul', 'dance', 'edm', 'metal', 'escape room', 'new age', 'ambient', 'meditation'],
            datasets: [
                {
