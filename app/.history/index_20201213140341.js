...
function genresChart(jsonData) {
    ...
    const grammysGenresCtx = document.getElementById('grammys-genres').getContext('2d')
    let grammysGenresRect = document.getElementById('grammys-genres').parentNode.getBoundingClientRect()
